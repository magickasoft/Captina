          ...
          <View style={styles.dataCard}>
            ...
            <View style={[styles.cardNumberField, styles.fieldWrap]}>
              ...
              <TextInput
                  ...
                  style={[styles.inputField, this.checkEditing(nameFieldCard) ? error ? styles.borderError : styles.borderCorrectly : styles.defaultBorder]}
            ...
            <View style={[styles.cvvField, styles.fieldWrap]}>
              ...
              <TextInput
                  ...
                  maxLength={4}
                  style={[styles.inputField, this.checkEditing(nameFieldCVV) ? errorCVV ? styles.borderError : styles.borderCorrectly : styles.defaultBorder]}
            ...
            <View style={[styles.expireDateField, styles.fieldWrap]}>
              ...
              <View style={styles.inputWrap}>
                <TextInput
                    keyboardType="numeric"
                    style={[styles.inputField, this.checkEditing(nameFieldMM) ? errorExpMM ? styles.borderError : styles.borderCorrectly : styles.defaultBorder, {marginRight: 6}]}
                    placeholder="MM"
                    maxLength={2}
              ...
              <View style={styles.inputWrap}>
                <TextInput
                    keyboardType="numeric"
                    style={[styles.inputField, this.checkEditing(nameFieldYY) ? errorExpYY ? styles.borderError : styles.borderCorrectly : styles.defaultBorder]}
                    placeholder="YYYY"
                    maxLength={4}
